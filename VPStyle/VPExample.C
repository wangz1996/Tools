...
{ 
  ...
  //VP_LABEL(0.2,0.2); myText( 0.37,0.2,1,"Preliminary");

  // new method for VP labels. Use this!
  //VPLabel(0.2,0.2);
  VPLabel(0.2,0.2,"Preliminary");
  //VPLabel(0.2,0.2,"Work in progress");

  c1->Print("VPExample.eps");
  c1->Print("VPExample.png");
  c1->Print("VPExample.pdf");
